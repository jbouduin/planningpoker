...
test('Handle reset', () => {
  ...
  // scrum master should have received create messages + 3 joins + 1 pause + 1 reset
  ...
  // participant 1 should have received create messages + 2 joins + 1 pause + 1 reset
  ...
  // participant 2 should have received create messages + 1 self (pause), no join and no reset
  ...
  // observer should have received create messages +  1 reset and no joins
