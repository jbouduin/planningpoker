...
test('Handle ping', () => {
  ...
  // scrum master should have received create messages + 3 joins + 1 pause + 1 ping
  ...
  // participant 1 should have received create messages + 2 joins + 1 pause + 1 ping
  ...
  // participant 2 should have received create messages + 1 self (pause), no join and no ping
  ...
  // observer should have received create messages +  1 ping and no joins
